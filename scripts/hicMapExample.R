...
## Plot region
pdf(file = "plots/hicMapExample01.pdf", width = 8, height = 4)
pageCreate(width = 8, height = 4, showGuides = FALSE)
plotRegion(p = p, hic = hic)
dev.off()

## Show genomic loci and loop
pdf(file = "plots/hicMapExample02.pdf", width = 8, height = 4)
pageCreate(width = 8, height = 4, showGuides = FALSE)
plotRegion(p = p, hic = hic)
...
p2$width <- 1.0
p2$height <- 1.0
pdf(file = "plots/hicMapExample03.pdf", width = 8, height = 4)
pageCreate(width = 8, height = 4, showGuides = FALSE)
plotRegion(p = p, hic = hic)
addLoop(hic = hic, loop = loop)
...
pdf(file = "plots/hicMapExample04.pdf", width = 8, height = 4)
pageCreate(width = 8, height = 4, showGuides = FALSE)
p3 <- p
p3$resolution <- 10e03
p3$zrange <- c(0, 300)
...
pdf(file = "plots/hicMapExample05.pdf", width = 8, height = 4)
pageCreate(width = 8, height = 4, showGuides = FALSE)
p4 <- p
p4$resolution <- 5e03
p4$zrange <- c(0, 100)
